(function () {
    ...
    const exactMap = {
        ...
        '格式：邮箱----密码----client_id----refresh_token（可再加 ----辅助邮箱----辅助密码），支持批量导入（每行一个）': 'Format: email----password----client_id----refresh_token (optional ----recovery_email----recovery_password), supports bulk import (one per line)',
